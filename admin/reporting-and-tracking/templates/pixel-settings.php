...
if ( isset( $_POST['wpswocuf_pro_common_settings_save'] ) ) {
	...
	$wpswocuf_upsell_fb_pixel_config = array(
...
$wpswocuf_google_analytics_fields = array(
	...
	'wpswocuf_pixel_account_id'      => array(
		...
		'value'                 => ! empty( $wpswocuf_upsell_fb_pixel_config['pixel_account_id'] ) ? sanitize_text_field( wp_unslash( $wpswocuf_upsell_fb_pixel_config['pixel_account_id'] ) ) : '',
	),

	'wpswocuf_enable_pixel_basecode' => array(
		...
		'value'                 => ! empty( $wpswocuf_upsell_fb_pixel_config['enable_pixel_basecode'] ) ? sanitize_text_field( wp_unslash( $wpswocuf_upsell_fb_pixel_config['enable_pixel_basecode'] ) ) : 'no',
	),
	...
	'wpswocuf_enable_purchase_event' => array(
		...
		'value'                 => ! empty( $wpswocuf_upsell_fb_pixel_config['enable_purchase_event'] ) ? sanitize_text_field( wp_unslash( $wpswocuf_upsell_fb_pixel_config['enable_purchase_event'] ) ) : 'no',
	),
);
		...
		<tbody>
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<span class="wpswocuf_upsell_other_plugin_author_name"><?php esc_html_e( 'By Facebook', 'woo-one-click-upsell-funnel' ); ?></span>
				</th>
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<span class="wpswocuf_upsell_other_plugin_author_name light"><?php esc_html_e( 'By AdEspresso', 'woo-one-click-upsell-funnel' ); ?></span>
				</th>
				<td class="forminp forminp-text">
					<span class="wpswocuf_upsell_global_description">
						<?php
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<span class="wpswocuf_upsell_other_plugin_author_name light"><?php esc_html_e( 'By weDevs', 'woo-one-click-upsell-funnel' ); ?></span>
				</th>
				<td class="forminp forminp-text">
					<span class="wpswocuf_upsell_global_description">
						<?php
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<span class="wpswocuf_upsell_other_plugin_author_name light"><?php esc_html_e( 'By Night Shift Apps', 'woo-one-click-upsell-funnel' ); ?></span>
				</th>
				<td class="forminp forminp-text">
					<span class="wpswocuf_upsell_global_description">
						<?php
