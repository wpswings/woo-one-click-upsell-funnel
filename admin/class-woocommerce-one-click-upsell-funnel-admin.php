	...
	public function activate_respective_offer_template() {
		...
		foreach ( $offer_templates_array as $template_key => $callback_function ) {
			...
			if ( $template_id == 'five' ) {
				...
				$get_post_contents  ='[et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" background_color="#0c0c0c" custom_padding="0px||0px||false|false" locked="off" global_colors_info="{}"][et_pb_row _builder_version="4.18.1" _module_preset="default" background_enable_color="off" global_colors_info="{}"][et_pb_column type="4_4" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_image src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/logo-4.png" title_text="Group 1321" align="center" _builder_version="4.18.1" _module_preset="default" width="19%" max_width="19%" module_alignment="center" global_colors_info="{}"][/et_pb_image][/et_pb_column][/et_pb_row][/et_pb_section][et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" custom_margin="||||false|false" custom_padding="0px||0px||false|false" global_colors_info="{}"][et_pb_row column_structure="1_2,1_2" _builder_version="4.18.1" _module_preset="default" width="35%" hover_enabled="0" global_colors_info="{}" sticky_enabled="0"][et_pb_column type="1_2" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_text _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"]Step 3 of 4: Customize Your Order[/et_pb_text][/et_pb_column][et_pb_column type="1_2" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_text _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"]<p style="text-align: right;">75% Completed</p>[/et_pb_text][/et_pb_column][/et_pb_row][/et_pb_section][et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" background_image="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-17.png" min_height="320px" global_colors_info="{}"][/et_pb_section][et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_row column_structure="1_2,1_2" make_equal="on" _builder_version="4.18.1" _module_preset="default" custom_css_main_element="align-items: center;" global_colors_info="{}"][et_pb_column type="1_2" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_text _builder_version="4.18.1" _module_preset="default" header_3_font="Frank Ruhl Libre|||on|||||" header_3_text_color="#0c0c0c" header_3_font_size="40px" header_3_line_height="1.2em" header_5_font="Content||||||||" header_5_text_color="#b8822c" header_5_font_size="24px" header_5_line_height="1.3em" custom_margin="||||false|false" global_colors_info="{}"]<h5>{[customer_first_name]},</h5>
<h3>I’d Like To Point You This Awesome Item</h3>
<p>Add this to you order and get 20% discount. We will ship it with other items.</p>[/et_pb_text]<h4>[wps_upsell_price]</h4>[et_pb_code _builder_version="4.18.1" _module_preset="default" width="100%" max_width="100%" module_alignment="left" custom_margin="0px|0px|0px|0px|false|false" custom_padding="0px||0px||false|false" locked="off" global_colors_info="{}"]<style><!-- [et_pb_line_break_holder] -->  .wps-btn-wrap {<!-- [et_pb_line_break_holder] -->    display: flex;<!-- [et_pb_line_break_holder] -->    flex-direction: column;<!-- [et_pb_line_break_holder] -->    align-items: flex-start;<!-- [et_pb_line_break_holder] -->    padding-top: 0px;<!-- [et_pb_line_break_holder] -->    width: 100%;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-btn-wrap .et_pb_button_module_wrapper ~ a {<!-- [et_pb_line_break_holder] -->    margin-top: 10px;<!-- [et_pb_line_break_holder] -->    color: #000;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-btn-wrap a.et_pb_button {<!-- [et_pb_line_break_holder] -->    background-color: #0C0C0C;<!-- [et_pb_line_break_holder] -->    border: 0;<!-- [et_pb_line_break_holder] -->    color: #fff;<!-- [et_pb_line_break_holder] -->    font-size: 16px;<!-- [et_pb_line_break_holder] -->    border-radius: 5px;<!-- [et_pb_line_break_holder] -->        padding: 6px 25px !important;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->.wps-btn-wrap .et_pb_button_module_wrapper {<!-- [et_pb_line_break_holder] -->    margin-right: 20px;<!-- [et_pb_line_break_holder] -->    margin-bottom: 0 !important;<!-- [et_pb_line_break_holder] -->    display: inline-flex;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-btn-wrap a.et_pb_button:hover {<!-- [et_pb_line_break_holder] -->    padding: 6px 25px !important;<!-- [et_pb_line_break_holder] -->    background-color: #000 !important;<!-- [et_pb_line_break_holder] -->    border: 0 !important;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-btn-wrap a.et_pb_button:after{<!-- [et_pb_line_break_holder] -->    display: none;<!-- [et_pb_line_break_holder] -->  }<!-- [et_pb_line_break_holder] --></style><!-- [et_pb_line_break_holder] --><!-- [et_pb_line_break_holder] --><div class="wps-btn-wrap et_pb_row et_pb_equal_columns wps-add-to-cart"><!-- [et_pb_line_break_holder] --><div class="et_pb_button_module_wrapper et_pb_button_0_wrapper et_pb_button_alignment_left et_pb_module " bis_skin_checked="1"><!-- [et_pb_line_break_holder] -->				<a class="et_pb_button et_pb_button_0 et_pb_bg_layout_light" href="[wps_upsell_yes]" data-icon="">ADD THIS TO MY ORDER</a><!-- [et_pb_line_break_holder] -->			</div><!-- [et_pb_line_break_holder] -->  <a href="[wps_upsell_no]">No thanks, I don’t want to take advantage of this offer</a><!-- [et_pb_line_break_holder] --></div><!-- [et_pb_line_break_holder] -->[/et_pb_code][/et_pb_column][et_pb_column type="1_2" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][wps_upsell_image][/et_pb_column][/et_pb_row][/et_pb_section][et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" background_color="rgba(231,193,109,0.22)" global_colors_info="{}"][et_pb_row _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_column type="4_4" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_text _builder_version="4.18.1" _module_preset="default" header_3_font="Frank Ruhl Libre|||on|||||" header_3_text_color="#0c0c0c" header_3_font_size="40px" header_5_font="Content||||||||" header_5_text_color="#b8822c" header_5_font_size="28px" global_colors_info="{}"]<h5 style="text-align: center;">Have A Look At</h5>
<h3 style="text-align: center;">Some of our best Products</h3>[/et_pb_text][/et_pb_column][/et_pb_row][et_pb_row module_class="wps-tab-nav" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_column type="4_4" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_tabs _builder_version="4.18.1" _module_preset="default" body_text_align="center" background_color="RGBA(255,255,255,0)" hover_enabled="0" custom_css_main_element="border: solid 0px||  " custom_css_tabs_controls="  background-color: transparent;||  display: flex;||  align-items: center;||  justify-content: center;||" custom_css_tab="border: solid 0px;||margin-bottom: 30px;||color: #B8822C !important;" custom_css_active_tab="background-color: transparent;||color: #B8822C !important;" custom_css_tabs_content="background-color: #faf2e0;||" global_colors_info="{}" sticky_enabled="0"][et_pb_tab title="All" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"]<div class="wps-items-wrapper" style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-gap: 30px;">
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-08.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-10.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-09.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-07.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-11.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-12.png" /></div>
</div>[/et_pb_tab][et_pb_tab title="Nail" _builder_version="4.18.1" _module_preset="default" hover_enabled="0" global_colors_info="{}" sticky_enabled="0"]<div class="wps-items-wrapper" style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-gap: 30px;">
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-08.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-10.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-09.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-07.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-11.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-12.png" /></div>
</div>[/et_pb_tab][et_pb_tab title="Hair" _builder_version="4.18.1" _module_preset="default" hover_enabled="0" global_colors_info="{}" sticky_enabled="0"]<div class="wps-items-wrapper" style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-gap: 30px;">
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-08.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-10.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-09.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-07.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-11.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-12.png" /></div>
</div>[/et_pb_tab][et_pb_tab title="Face" _builder_version="4.18.1" _module_preset="default" hover_enabled="0" global_colors_info="{}" sticky_enabled="0"]<div class="wps-items-wrapper" style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-gap: 30px;">
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-08.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-10.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-09.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-07.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-11.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-12.png" /></div>
</div>[/et_pb_tab][et_pb_tab title="SPA" _builder_version="4.18.1" _module_preset="default" hover_enabled="0" global_colors_info="{}" sticky_enabled="0"]<div class="wps-items-wrapper" style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-gap: 30px;">
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-08.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-10.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-09.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-07.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-11.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-12.png" /></div>
</div>[/et_pb_tab][et_pb_tab title="OILS" _builder_version="4.18.1" _module_preset="default" hover_enabled="0" global_colors_info="{}" sticky_enabled="0"]<div class="wps-items-wrapper" style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-gap: 30px;">
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-08.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-10.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-09.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-07.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-11.png" /></div>
<div class="wps-item" style="border-radius: 100% 100% 0px 0px; overflow: hidden;"><img src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-12.png" /></div>
</div>[/et_pb_tab][/et_pb_tabs][/et_pb_column][/et_pb_row][/et_pb_section][et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" custom_padding="||54px|||" global_colors_info="{}"][et_pb_row _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_column type="4_4" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_text _builder_version="4.18.1" _module_preset="default" header_3_font="Frank Ruhl Libre|||on|||||" header_3_text_color="#0c0c0c" header_3_font_size="40px" header_5_font="Content||||||||" header_5_text_color="#b8822c" header_5_font_size="28px" locked="off" global_colors_info="{}"]<h5 style="text-align: center;">Our Blog</h5>
<h3 style="text-align: center;">LATEST ARTICLES &amp; NEWS</h3>[/et_pb_text][/et_pb_column][/et_pb_row][et_pb_row column_structure="1_3,1_3,1_3" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_column type="1_3" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_image src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-06.png" align="right" _builder_version="4.18.1" _module_preset="default" positioning="relative" custom_padding="0px|||||" global_colors_info="{}"][/et_pb_image][et_pb_text _builder_version="4.18.1" _module_preset="default" header_3_font="Cormorant Infant||||||||" header_3_text_color="#cfad77" header_3_font_size="38px" transform_rotate="0deg|0deg|270deg" positioning="absolute" vertical_offset="14px" horizontal_offset="-128px" width="100%" global_colors_info="{}" position_origin_a__hover_enabled="off|desktop" positioning__hover_enabled="off|desktop" position_origin_f__hover_enabled="off|desktop" position_origin_r__hover_enabled="off|desktop"]<h3>SKIN CARE</h3>[/et_pb_text][/et_pb_column][et_pb_column type="1_3" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_image src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-05.png" align="right" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][/et_pb_image][et_pb_text _builder_version="4.18.1" _module_preset="default" header_3_font="Cormorant Infant||||||||" header_3_text_color="#cfad77" header_3_font_size="38px" transform_rotate="0deg|0deg|270deg" positioning="absolute" vertical_offset="14px" horizontal_offset="-128px" width="100%" global_colors_info="{}" position_origin_a__hover_enabled="off|desktop" positioning__hover_enabled="off|desktop" position_origin_f__hover_enabled="off|desktop" position_origin_r__hover_enabled="off|desktop"]<h3>SKIN CARE</h3>[/et_pb_text][/et_pb_column][et_pb_column type="1_3" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_image src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/item-04.png" align="right" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][/et_pb_image][et_pb_text _builder_version="4.18.1" _module_preset="default" header_3_font="Cormorant Infant||||||||" header_3_text_color="#cfad77" header_3_font_size="38px" transform_rotate="0deg|0deg|270deg" positioning="absolute" vertical_offset="14px" horizontal_offset="-128px" width="100%" global_colors_info="{}" position_origin_a__hover_enabled="off|desktop" positioning__hover_enabled="off|desktop" position_origin_f__hover_enabled="off|desktop" position_origin_r__hover_enabled="off|desktop"]<h3>NIAL ART</h3>[/et_pb_text][/et_pb_column][/et_pb_row][/et_pb_section][et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" background_color="#dfcca0" global_colors_info="{}"][et_pb_row _builder_version="4.18.1" _module_preset="default" locked="off" global_colors_info="{}"][et_pb_column type="4_4" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_text _builder_version="4.18.1" _module_preset="default" header_3_font="Frank Ruhl Libre|||on|||||" header_3_text_color="#0c0c0c" header_3_font_size="40px" header_5_font="Content||||||||" header_5_text_color="#b8822c" header_5_font_size="28px" locked="off" global_colors_info="{}"]<h5 style="text-align: center;">Our Blog</h5>
<h3 style="text-align: center;">hERE’S a lAST cHANCE fOR yOU</h3>[/et_pb_text][/et_pb_column][/et_pb_row][et_pb_row _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_column type="4_4" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_code _builder_version="4.18.1" _module_preset="default" custom_css_main_element="    display: flex;||    align-items: center;||    justify-content: center;||    flex-direction: column;" global_colors_info="{}"]<style><!-- [et_pb_line_break_holder] -->.wps-custom-btn a {<!-- [et_pb_line_break_holder] -->    display: flex;<!-- [et_pb_line_break_holder] -->    align-items: center;<!-- [et_pb_line_break_holder] -->    background-color: #0C0C0C;<!-- [et_pb_line_break_holder] -->    flex-direction: column;<!-- [et_pb_line_break_holder] -->    border: 0;<!-- [et_pb_line_break_holder] -->    color: #fff;<!-- [et_pb_line_break_holder] -->    line-height: 16px !important;<!-- [et_pb_line_break_holder] -->    font-size: 22px;<!-- [et_pb_line_break_holder] -->    padding: 14px 30px;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-custom-btn a span {<!-- [et_pb_line_break_holder] -->    font-size: 13px;<!-- [et_pb_line_break_holder] -->    line-height: 16px;<!-- [et_pb_line_break_holder] -->    margin-top: 10px;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-custom-btn ~ a {<!-- [et_pb_line_break_holder] -->    text-align: center;<!-- [et_pb_line_break_holder] -->    margin: 0 auto;<!-- [et_pb_line_break_holder] -->    display: block;<!-- [et_pb_line_break_holder] -->    color: #000000;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-custom-btn a::after{<!-- [et_pb_line_break_holder] -->    display: none;<!-- [et_pb_line_break_holder] -->  }<!-- [et_pb_line_break_holder] -->  .wps-custom-btn a:hover {<!-- [et_pb_line_break_holder] -->    padding: 14px 30px !important;<!-- [et_pb_line_break_holder] -->    background-color: #000 !important;<!-- [et_pb_line_break_holder] -->    border: 0px solid transparent !important;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  <!-- [et_pb_line_break_holder] --></style><!-- [et_pb_line_break_holder] --><div class="wps-custom-btn et_pb_button_module_wrapper et_pb_button_0_wrapper et_pb_button_alignment_left et_pb_module " bis_skin_checked="1"><!-- [et_pb_line_break_holder] -->				<a class="et_pb_button et_pb_button_0 et_pb_bg_layout_light" href="[wps_upsell_yes]" data-icon="">ADD THIS TO MY ORDER <span>We will ship it out in same package.</span> </a><!-- [et_pb_line_break_holder] -->			</div><!-- [et_pb_line_break_holder] --><!-- [et_pb_line_break_holder] --><a href="[wps_upsell_no]">No thanks, I don’t want to take advantage of this offer</a>[/et_pb_code][/et_pb_column][/et_pb_row][/et_pb_section][et_pb_section fb_built="1" _builder_version="4.18.1" _module_preset="default" background_color="#0c0c0c" custom_padding="0px||0px||false|false" global_colors_info="{}"][et_pb_row column_structure="1_2,1_2" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_column type="1_2" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_image src="https://demo.wpswings.com/one-click-upsell-funnel-for-woocommerce-pro/wp-content/uploads/upsell_images/template-images/logo-4.png" _builder_version="4.18.1" _module_preset="default" width="40%" global_colors_info="{}"][/et_pb_image][/et_pb_column][et_pb_column type="1_2" _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"][et_pb_code _builder_version="4.18.1" _module_preset="default" global_colors_info="{}"]<style><!-- [et_pb_line_break_holder] -->.wps-footer-link-wrapper ul {<!-- [et_pb_line_break_holder] -->    display: flex;<!-- [et_pb_line_break_holder] -->    list-style: none;<!-- [et_pb_line_break_holder] -->    justify-content: end;<!-- [et_pb_line_break_holder] -->    align-items: center;<!-- [et_pb_line_break_holder] -->    padding: 5px 0px;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] -->  .wps-footer-link-wrapper ul li a {<!-- [et_pb_line_break_holder] -->    padding: 0px 8px;<!-- [et_pb_line_break_holder] -->    color: #ffffff;<!-- [et_pb_line_break_holder] -->}<!-- [et_pb_line_break_holder] --></style><!-- [et_pb_line_break_holder] --><div class="wps-footer-link-wrapper"><!-- [et_pb_line_break_holder] --><ul><!-- [et_pb_line_break_holder] -->  <li><a href="#">Privacy Policy</a></li><!-- [et_pb_line_break_holder] -->  <li><a href="#">Terms & Conditions</a></li><!-- [et_pb_line_break_holder] --></ul><!-- [et_pb_line_break_holder] --></div>[/et_pb_code][/et_pb_column][/et_pb_row][/et_pb_section]';
