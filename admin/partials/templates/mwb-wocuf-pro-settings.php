			...
			<tbody>
				...
				<tr valign="top">
					...
					<td class="forminp forminp-text">
						...
						mwb_upsell_lite_wc_help_tip( $attribut_description ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						?>
				...
				<tr valign="top">
					...
					<th scope="row" class="titledesc">
						<label for="mwb_wocuf_enable_plugin"><?php esc_html_e( 'Smart Skip If Already Purchased', 'woo-one-click-upsell-funnel' ); ?></label>
					</th>
