...
<div id="wpswocuf_upsell_lite_overview">
	<div id="wpswocuf_upsell_lite_overview_video">
	...
	<div id="wpswocuf_upsell_lite_overview_pro_version">
		...
		<div class="wpswocuf_upsell_overview_supported_product">
			...
			<div class="wpswocuf_upsell_overview_product_icon subscription">
				<img src="<?php echo esc_url( wpswocuf_URL . 'admin/resources/subscription-products.png' ); ?>">
		...
		<div class="wpswocuf_upsell_overview_supported_payment_gateways">
			<div class="wpswocuf_upsell_overview_supported_payment_gateways_banner">
				<img src="<?php echo esc_url( wpswocuf_URL . 'admin/resources/payment-gateways.jpg' ); ?>">
			</div>
		</div>
		<h3><?php esc_html_e( 'Supported Woocommerce Add-ons', 'woo-one-click-upsell-funnel' ); ?></h3>
		<div class="wpswocuf_upsell_overview_supported_woo_addons">
			<div class="wpswocuf_upsell_overview_supported_woo_addons_banner">
				<img src="<?php echo esc_url( wpswocuf_URL . 'admin/resources/woo-subscription-compatibility.jpg' ); ?>">
			</div>
		</div>
		<div class="wpswocuf_upsell_overview_go_pro">
			<a class="button wpswocuf_upsell_overview_go_pro_button" target="_blank" href="https://wpswings.com/product/one-click-upsell-funnel-for-woocommerce-pro/?utm_source=wpswings-upsell-pro&utm_medium=upsell-org-backend&utm_campaign=upsell-pro"><?php echo esc_html__( 'Upgrade to Premium', 'woo-one-click-upsell-funnel' ) . ' &rarr;'; ?></a>
		</div>
	</div>
</div>
