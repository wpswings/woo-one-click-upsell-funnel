...
if ( class_exists( 'wpswocuf_Upsell_Report_Sales_By_Date' ) ) {
	return;
}

/**
 * wpswocuf_Upsell_Report_Sales_By_Date.
 */
class wpswocuf_Upsell_Report_Sales_By_Date extends WC_Admin_Report {
	...
	private function query_report_data() {
		...
		$this->report_data = apply_filters( 'wpswocuf_pro_upsell_sales_report_data', $this->report_data );
	}
