		...
		function mwb_upsell_lite_add_doc_and_premium_link( $links, $file ) {
			...
			if ( false !== strpos( $file, 'woocommerce-one-click-upsell-funnel.php' ) ) {
				...
				$row_meta = array(
					...
					'goPro'   => '<a target="_blank" style="color:#FFF;background:linear-gradient(to right,#45b649,#dce35b);padding:5px;border-radius:6px;" href="http://wpswings.com/product/one-click-upsell-funnel-for-woocommerce-pro/"><strong>' . esc_html__( 'Go Premium', 'woo-one-click-upsell-funnel' ) . '</strong></a>',
