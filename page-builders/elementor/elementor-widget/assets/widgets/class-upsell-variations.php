 ...
 * @since 1.0.0
 */
class Wpswocuf_Upsell_Variations extends Widget_Base {
	...
	public function get_name() {
		return 'wpswocuf-upsell-variations';
	}
	...
	public function get_title() {
		return esc_html__( 'Upsell Variations', 'woo-one-click-upsell-funnel' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell variation shortcode', 'woo-one-click-upsell-funnel' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => array(
					'active' => true,
				),
				'placeholder' => '[wpswocuf_upsell_variations]',
				'default'     => '[wpswocuf_upsell_variations]',
			)
		);
