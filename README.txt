...
>_**WP Swings is just our improvised and rebranded version with all quality solutions and help being the same, so no worries at your end. Please [**Connect with us**](https://wpswings.com/contact-us/?utm_source=wpswings-contact&utm_medium=upsell-org-page&utm_campaign=contactus) for all setup, support, and update related queries without hesitation.**_
***
...
With the One Click Upsell Funnel plugin, you can create unlimited sales funnels with any number of Upsell and Cross-Sell Offers. In simple words, you can show your customers multiple offers in a single funnel which increases the impulse buys, Average Order Value, and revenue at your WooCommerce store.
...
**Payment Gateways Compatibilities(Pro Version)**
...
The manual installation method involves downloading our One Click Upsell for WooCommerce and uploading it to your webserver via your favourite FTP application. The WordPress codex contains [instructions on how to do this here](http://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
...
If you need support or have questions, kindly use our online chat window [**here**](https://wpswings.com/?utm_source=wpswings-official&utm_medium=upsell-org-page&utm_campaign=official) or connect with us then [**Generate a ticket**](https://wpswings.com/submit-query/?utm_source=wpswings-submit-query&utm_medium=upsell-org-page&utm_campaign=query)


== Screenshots ==

1. Create a new Funnel: Create a new upsell funnel by clicking on Create New Funnel button
2. Add Offer in the funnel: Add an offered product in your upsell funnel
...
You need to copy this **Buy Now → [mwb_upsell_yes]** and place it at a suitable place on your page.
...
You need to copy this **No Thanks → [mwb_upsell_no]** and place it at a suitable place on your page.
...
= 3.2.0 - Released on 30 March 2022 =
...
* Improved: Compatibility with latest WP(5.8) and WC(5.6.0)
* Other: Issues and Bugs Fixed.

= 3.0.3 - Released on 6 April 2021 =
* Improved: Compatibility with latest WP(5.7) and WC(5.1.0)
* Other: Issues and Bugs Fixed.
